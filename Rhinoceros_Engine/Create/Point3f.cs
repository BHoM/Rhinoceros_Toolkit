...
namespace BH.Engine.Adapters.Rhinoceros
{
    public static partial class Create
    {
        ...
        [Description("Creates a random Rhino Point3f using the provided Random instance.")]
        [Input("random", "The Random instance used to generate coordinate values.")]
        [Output("point", "A random Rhino Point3f with X, Y, Z coordinates between 0 and 1.")]
        ...
        [Description("Creates a random Rhino Point3f using a seed value.")]
